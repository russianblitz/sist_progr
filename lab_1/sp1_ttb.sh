...
echo "Добрый день! Меня разработал Цыриторов Цырен из гр.739-1"
echo "Программа называется: Режим бога. Шучу, я менеджер паролей"
echo "Меня создали с целью блокировки/разблокировки пользователей в системе"
